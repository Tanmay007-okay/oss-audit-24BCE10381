...
| Field | Details |
|---|---|
| **Student Name** | Tanmay Joshi |
| **Registration Number** | 24BCE10381 |
...
```bash
git clone https://github.com/Tanmay007-okay/oss-audit-24BCE10381.git
cd oss-audit-24BCE10381
```
